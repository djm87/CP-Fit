function errTotal = EPSC_WrapperFunction_MultObj(par,systemParams)
    ...
    parfor i = 1:size(targetFolders,1)
        ...
        epscData = importdata('epsc3.out');
        epscData = epscData.data;
        curSSCurves{i} = epscData;
    end
    ...
    for i = 1:totalCases
        for j = 1:nPop
            foldCount = foldCount + 1;
            epscData = curSSCurves{foldCount};
            ...
            simModx = abs(epscData(:,curDir));
            simMody = abs(epscData(:,curDir+6));
