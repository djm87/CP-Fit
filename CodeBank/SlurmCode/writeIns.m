...
SampleDir={'//Split_Hopkinson_Bar/s1_2545_T5';
           ...
           '//Taylor_Cylinders/Dir1_sample1_def_v188';
           '//Taylor_Cylinders/Dir1_sample1_undef';
           '//Taylor_Cylinders/Dir1_sample2_undef';
           '//Taylor_Cylinders/Dir2_sample1_undef';
           '//Taylor_Cylinders/Dir2_sample2_def_v185';
           '//Taylor_Cylinders/Dir2_sample2_undef';
           '//Taylor_Cylinders/Dir3_sample1_def_v192';
           '//Taylor_Cylinders/Dir3_sample1_undef';
           '//Taylor_Cylinders/Dir3_sample2_def_v212';
           '//Taylor_Cylinders/Dir3_sample2_def_v212_fragment';
           '//Taylor_Cylinders/Dir3_sample2_undef'
           '//Taylor_Cylinders/Dir45_sample1_def_v188'
           '//Taylor_Cylinders/Dir45_sample1_undef';
           '//Taylor_Cylinders/Dir45_sample2_undef'};    
...
InputParTmp='/Initial_template.par';
for i=1:nSamples
    InputPar{i,1}=InputParTmp;
end
InputPar{8,1}='/initial.par';
InputPar{14,1}='/initial.par';
InputPar{16,1}='/initial.par';
