...
2      Process Control Variable, "i_control_var"  [0=temp, 1-6=corresponding known etbc(1-6) or stbc(1-6) component
0      Relative or absolute boundary conditions, i_bc_mode" [0 for relative BC, 1 for absolute BC]
__________________________________
STRAINS
